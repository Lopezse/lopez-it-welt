    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="prose max-w-none">
                ...
                <p>
                    Diese Website verwendet Cookies, um Ihnen das bestmögliche Nutzererlebnis zu bieten.
                    Sie können Ihre Cookie-Einstellungen jederzeit anpassen.
                </p>

                <h2>Was sind Cookies?</h2>
                <p>
                    Cookies sind kleine Textdateien, die auf Ihrem Computer gespeichert werden, wenn Sie eine Website besuchen.
                    Sie werden häufig verwendet, um Websites funktionsfähig oder effizienter zu machen sowie dem Websitebetreiber
                ...
                <p>
                    Diese Cookies sind für das Funktionieren der Website erforderlich und können in unseren Systemen nicht
                    abgeschaltet werden. Sie werden in der Regel nur als Reaktion auf von Ihnen getätigte Aktionen gesetzt,
                    wie z. B. das Festlegen Ihrer Datenschutzeinstellungen, das Anmelden oder das Ausfüllen von Formularen.
                </p>
                ...
                <p>
                    ...
                    Website messen und verbessern können. Sie helfen uns zu verstehen, welche Seiten am beliebtesten und
                    am wenigsten beliebt sind und wie Besucher sich auf der Website bewegen.
                </p>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-sm text-gray-600">Immer aktiv - für die Grundfunktionen der Website erforderlich</p>
                            </div>
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-sm text-gray-600">Verbessern die Funktionalität und Personalisierung</p>
                            </div>
                ...
                <p>
                    Sie können Ihre Cookie-Einstellungen jederzeit ändern. Bitte beachten Sie, dass das Deaktivieren
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
                    ...
                    <p className="text-blue-700">
                        Ihre Cookie-Einstellungen werden in Ihrem Browser gespeichert und bleiben bestehen,
                        bis Sie sie ändern oder Ihren Browser-Cache löschen.
                    </p>
                </div>

                <h2>Drittanbieter-Cookies</h2>
                <p>
                    Einige Cookies werden von Drittanbietern gesetzt, die auf unserer Website tätig sind.
                    Diese helfen uns, die Website zu verbessern und Ihnen relevante Inhalte anzuzeigen.
                </p>

                <h2>Weitere Informationen</h2>
                <p>
                    Für weitere Informationen zu Cookies und deren Verwendung besuchen Sie bitte unsere
                    <a href="/datenschutz" className="text-blue-600 hover:text-blue-800 underline">Datenschutzerklärung</a>.
                </p>
