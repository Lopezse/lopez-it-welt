  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="prose max-w-none">
        ...
        <p>
          Diese Website verwendet Cookies, um Ihnen das bestmögliche Nutzererlebnis zu bieten. Sie
          können Ihre Cookie-Einstellungen jederzeit anpassen.
        </p>

        <h2>Was sind Cookies?</h2>
        <p>
          Cookies sind kleine Textdateien, die auf Ihrem Computer gespeichert werden, wenn Sie eine
          Website besuchen. Sie werden häufig verwendet, um Websites funktionsfähig oder effizienter
          zu machen sowie dem Websitebetreiber Informationen zu liefern.
        </p>
        ...
        <p>
          Diese Cookies sind für das Funktionieren der Website erforderlich und können in unseren
          Systemen nicht abgeschaltet werden. Sie werden in der Regel nur als Reaktion auf von Ihnen
          getätigte Aktionen gesetzt, wie z. B. das Festlegen Ihrer Datenschutzeinstellungen, das
          Anmelden oder das Ausfüllen von Formularen.
        </p>
        ...
        <p>
          ...
          Seiten am beliebtesten und am wenigsten beliebt sind und wie Besucher sich auf der Website
          bewegen.
        </p>
        ...
        <div className="bg-gray-100 p-4 rounded-lg mb-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <div className="bg-green-500 text-white px-3 py-1 rounded text-sm">Aktiv</div>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="bg-gray-300 text-gray-700 px-3 py-1 rounded text-sm">Inaktiv</div>
            </div>
        ...
        <p>
          Sie können Ihre Cookie-Einstellungen jederzeit ändern. Bitte beachten Sie, dass das
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
          ...
          <p className="text-blue-700">
            Ihre Cookie-Einstellungen werden in Ihrem Browser gespeichert und bleiben bestehen, bis
            Sie sie ändern oder Ihren Browser-Cache löschen.
          </p>
        </div>
        ...
        <h2>Kontakt</h2>
        <p>Bei Fragen zu unseren Cookie-Einstellungen kontaktieren Sie uns bitte:</p>
        <p>
          Lopez IT Welt
          <br />
          [Ihre Kontaktdaten]
