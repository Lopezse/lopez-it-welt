...
import { ComplianceAgent, DevelopmentAgent, KITask, QualityAgent } from "../lib/ki-agent";
...
async function testQualityAgent() {
  ...
  try {
    ...
    console.log("  - Success:", result.success);
    console.log("  - Enterprise Compliant:", result.compliance_result.is_compliant);
    console.log("  - Rules Applied:", result.rules_applied.length);
    console.log("  - Execution Time:", result.execution_time + "ms");
  } catch (error) {
...
async function testMemorySystem() {
  ...
  try {
    ...
    console.log("  - Compliance Rate:", stats.memory_stats.compliance_rate + "%");
  } catch (error) {
