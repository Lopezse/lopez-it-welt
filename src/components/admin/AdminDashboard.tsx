      ...
      <div className='relative z-10 space-y-6'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6'>
          <div className='group backdrop-blur-xl bg-weiss/10 rounded-2xl border border-weiss/20 p-6 shadow-2xl hover:bg-weiss/20 transition-all duration-500 hover:scale-105'>
            <div className='flex items-center justify-between'>
              <div>
                <p className='text-sm font-medium text-hellgrau mb-1'>
                  Offene Tickets
                </p>
                <p className='text-3xl font-bold text-weiss'>
          ...
          <div className='group backdrop-blur-xl bg-weiss/10 rounded-2xl border border-weiss/20 p-6 shadow-2xl hover:bg-weiss/20 transition-all duration-500 hover:scale-105'>
            <div className='flex items-center justify-between'>
              <div>
                ...
                <p className='text-3xl font-bold text-akzentblau'>
                  Heute 02:00
                </p>
              </div>
            ...
            <div className='space-y-4'>
              ...
              <div className='space-y-3 mt-6'>
                <div className='flex items-center justify-between'>
                  ...
                  <span className='text-weiss font-medium'>
                    {dashboardData.serverStatus.cpu}%
                  </span>
                </div>
          ...
          <div className='backdrop-blur-xl bg-weiss/10 rounded-2xl border border-weiss/20 p-8 shadow-2xl'>
            ...
            <div className='space-y-4'>
              ...
              <div className='space-y-3'>
                <h4 className='text-lg font-semibold text-weiss'>
                  Letzte Angriffe
                </h4>
                {[
                  {
                  ...
                  >
                    <div className='flex items-center space-x-3'>
                      ...
                      ></div>
                      <div>
                        <p className='text-sm text-weiss font-medium'>
                          {attack.type}
                        </p>
              ...
              <div className='mt-6 p-4 backdrop-blur-sm bg-gruen/10 rounded-xl border border-gruen/20'>
                <div className='flex items-center justify-between'>
                  <div className='flex items-center space-x-2'>
                    ...
                    <span className='text-gruen font-medium'>
                      Firewall aktiv
                    </span>
                  </div>
              ...
              {dashboardData.recentActivities.map(activity => (
                ...
                >
                  <div className='flex items-center space-x-3'>
                    ...
                    ></div>
                    <div>
                      <p className='text-weiss font-medium'>
                        {activity.message}
                      </p>
