...
const navigation = [
  ...
  },
  {
    ...
    description: "Enterprise++ PLAN • BUILD • RUN",
    gradient: "from-purple-600 to-indigo-600",
    submenu: [
      { name: "Module & Fortschritt", href: "/admin/agent-system" },
      { name: "Go-Live Check", href: "/admin/agent-system?tab=golive" },
      { name: "Risiko-Analyse", href: "/admin/agent-system?tab=risk" },
      { name: "Auto-Complete", href: "/admin/agent-system?tab=autocomplete" },
    ],
  },
  {
    name: "AI Center",
    ...
    description: "Enterprise++ KI-Zentrale",
    gradient: "from-amber-500 to-orange-600",
    submenu: [
      { name: "Übersicht", href: "/admin/ai" },
      { name: "Projekt-Analyzer", href: "/admin/ai/project-analyzer" },
      { name: "Entwicklungsaufträge", href: "/admin/ai/dev-tasks" },
      { name: "Executive Reports", href: "/admin/ai/reports" },
    ],
  },
  {
    name: "KI-Aktionen",
  ...
  {
    name: "Benutzer & Sicherheit",
    href: "/admin/settings/users",
    icon: "M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z",
    description: "Benutzer, Rollen & 2FA",
    gradient: "from-hauptblau to-akzentblau",
    submenu: [
      { name: "Alle Benutzer", href: "/admin/settings/users" },
      { name: "Rollen & Rechte", href: "/admin/settings/roles" },
      { name: "2FA-Einstellungen", href: "/admin/settings/security/2fa" },
      { name: "Passwort-Policy", href: "/admin/settings/security/password-policy" },
      { name: "Audit-Logs", href: "/admin/settings/security/audit" },
    ],
  },
  {
    name: "Einstellungen",
      ...
      <div className="relative z-10 h-full flex flex-col">
        ...
        <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
          {navigation.map((item) => {
            ...
            const isActiveItem = isActive(item.href) || isSubmenuActive(item.submenu || []);
                  ...
                  >
                    <svg
                      className={`w-5 h-5 ${isCollapsed ? "mx-auto" : "mr-3"} transition-all duration-300 ${
                        isActiveItem ? "text-weiss" : "text-hellgrau group-hover:text-weiss"
                      }`}
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
        ...
        {!isCollapsed && (
          <div className="p-4 border-t border-weiss/10">
            <div className="flex items-center space-x-3 p-3 rounded-xl bg-weiss/10 backdrop-blur-sm border border-weiss/20">
              ...
              <div>
                <span className="text-xs font-medium text-weiss">System Online</span>
