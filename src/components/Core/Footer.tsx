    ...
    <footer className='bg-dunkelgrau text-white py-12'>
      <div className='container mx-auto px-4'>
        <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
          {/* Unternehmen */}
          <div>
            <h3 className='text-xl font-bold mb-4 text-hauptblau'>Lopez IT Welt</h3>
            <p className='text-gray-300 mb-4'>
              Professionelle IT-Lösungen mit Fokus auf Barrierefreiheit und persönliche Betreuung.
            </p>
            <div className='flex space-x-4'>
              <a href='mailto:info@lopez-it-welt.de' className='text-hauptblau hover:text-akzent-orange transition-colors'>
                📧
              </a>
              <a href='tel:+49123456789' className='text-hauptblau hover:text-akzent-orange transition-colors'>
                📞
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <div className='text-gray-300 space-y-2'>
              ...
              <p>31515 Wunstorf</p>
              <p className='mt-2'>
                <a href='mailto:info@lopez-it-welt.de' className='hover:text-white transition-colors'>
