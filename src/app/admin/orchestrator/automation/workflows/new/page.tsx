/**
 * Workflow erstellen - Enterprise++ Standard
 * 
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          <p className="text-red-600 dark:text-red-400 mb-4">
            Sie haben keine Berechtigung, Workflows zu erstellen.
          </p>
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!Array.isArray(parsedSteps)) {
        setError("Schritte: Muss ein JSON-Array sein");
        return;
      }
      ...
      setError("Schritte: Ungültiges JSON-Format");
      return;
    }
    ...
    try {
      ...
      if (response.ok && data.success) {
        router.push(`/admin/orchestrator/automation/workflows/${data.data.id}`);
      } else {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Erstellen Sie einen neuen Multi-Step-Workflow
          </p>
        </div>
        ...
        <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-6">
          <p className="text-sm text-blue-800 dark:text-blue-200">
            <strong>Hinweis:</strong> Die tatsächliche Ausführung dieses Workflows hängt von der P7-Approval-Freigabe für den angegebenen Use-Case ab. 
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                placeholder="z.B. Media-KI-Automation-Workflow"
              />
            </div>
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                Der Use-Case muss über P7 freigegeben sein, damit der Workflow ausgeführt werden kann.
              </p>
            </div>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                Schritte (JSON-Array) <span className="text-red-500">*</span>
              </label>
              <JSONEditor
                value={formData.steps}
                onChange={(value) => setFormData({ ...formData, steps: value })}
                placeholder='[{"name": "Step 1", "agent": "media-ai-agent", "purpose": "analyze"}, {"name": "Step 2", "agent": "compliance-agent", "purpose": "validate"}]'
                className="mb-4"
              />
              <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                Mindestens ein Schritt ist erforderlich. Jeder Schritt sollte name, agent und purpose enthalten.
              </p>
            </div>
