...
export default ${formData.formName};
  ...
  async validateExistingForm(formPath: string): Promise<ComplianceResult> {
    try {
      ...
      // Fehler beim Validieren des Formulars: ${error}
      throw error;
    }
  }
}
