  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      if (step === "credentials") {
        ...
        console.log("Shop-Login versucht:", { email, password: "***" });
        ...
        if (data.success) {
          console.log("✅ Login erfolgreich, speichere Token...");
          // Token im localStorage speichern
          const token = btoa(JSON.stringify(data.data.user));
          localStorage.setItem("token", token);
          console.log("✅ Token gespeichert, leite weiter...");
          // Login erfolgreich, sofort weiterleiten
