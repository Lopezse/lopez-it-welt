...
const UeberUnsPage = () => {
  ...
  const erfahrungsListe = t("ueber_uns.besonders_erfahrung_liste") as unknown as string[];
    ...
    <div className="bg-weiss dark:bg-dunkelgrau text-dunkelgrau dark:text-weiss">
      ...
      <section className="relative py-20 md:py-32 bg-gradient-to-br from-hauptblau/10 to-akzentblau/10">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-4">{t("ueber_uns.titel")}</h1>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="md:w-1/2">
              ...
              <div className="space-y-4 text-lg leading-relaxed">
                ...
                <p className="font-semibold">{t("ueber_uns.gruender_text_3")}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            ...
            <div className="bg-weiss dark:bg-dunkelgrau p-8 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-bold mb-2">{t("ueber_uns.besonders_erfahrung_titel")}</h3>
            ...
            <div className="bg-weiss dark:bg-dunkelgrau p-8 rounded-lg shadow-md">
              <div className="text-4xl mb-4">🤝</div>
              <h3 className="text-xl font-bold mb-2">{t("ueber_uns.besonders_ehrlich_titel")}</h3>
              <p className="text-dunkelgrau dark:text-hellgrau">
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl leading-relaxed">{t("ueber_uns.ziel_text")}</p>
          </div>
        </div>
      </section>
    </div>
