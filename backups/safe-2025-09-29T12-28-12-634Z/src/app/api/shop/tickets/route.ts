...
export async function POST(request: NextRequest) {
  try {
    ...
    try {
      ...
      if (adminResponse.ok) {
        // Admin über neues Ticket informiert: ${ticket.id}
      } else {
        // Admin-Benachrichtigung fehlgeschlagen: ${adminResponse.status}
      }
    } catch {
      // Fehler bei Admin-Benachrichtigung
    }
    ...
    // E-Mail-Bestätigung an Kunde gesendet: ${customerEmail.subject}
