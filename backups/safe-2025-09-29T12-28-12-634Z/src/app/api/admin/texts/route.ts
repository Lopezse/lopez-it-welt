...
const mockTexts = [
  ...
  },
  {
    ...
    sprache: "de",
    inhalt: "Kontaktieren Sie uns und lassen Sie uns gemeinsam Ihre IT-Ziele erreichen.",
  },
  {
    id: 35,
    modul: "home",
...
export async function POST(request: Request) {
  try {
    ...
    // Fehler beim Erstellen des Textes: ${error}
    return NextResponse.json({ error: "Fehler beim Erstellen des Textes" }, { status: 500 });
  }
}
...
export async function PUT(request: Request) {
  try {
    ...
    // Fehler beim Aktualisieren des Textes: ${error}
    return NextResponse.json({ error: "Fehler beim Aktualisieren des Textes" }, { status: 500 });
  }
}
...
export async function DELETE(request: Request) {
  try {
    ...
    // Fehler beim Löschen des Textes: ${error}
    return NextResponse.json({ error: "Fehler beim Löschen des Textes" }, { status: 500 });
  }
}
