...
describe("Schaltflaeche", () => {
  it("sollte korrekt gerendert werden", () => {
    ...
    expect(screen.getByRole("button", { name: "Test Schaltfläche" })).toBeInTheDocument();
  });
  ...
  it("sollte mit verschiedenen Varianten gerendert werden", () => {
    const { rerender } = render(<Schaltflaeche variante="haupt">Haupt</Schaltflaeche>);
  ...
  it("sollte mit verschiedenen Größen gerendert werden", () => {
    const { rerender } = render(<Schaltflaeche groesse="klein">Klein</Schaltflaeche>);
