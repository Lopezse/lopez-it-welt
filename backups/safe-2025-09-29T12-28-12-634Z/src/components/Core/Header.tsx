...
export default function Header() {
  ...
  const [dataSource, setDataSource] = useState<"database" | "fallback" | "unknown">("unknown");
  ...
  return (
    <>
      ...
      {/* 📊 DATENQUELLE STATUS (nur in Entwicklung) */}
      {process.env.NODE_ENV === "development" && (
        <div className="fixed bottom-4 right-4 z-50 bg-black/80 text-white text-xs p-2 rounded shadow-lg">
