  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          Diese Cookie-Einstellungen ermöglichen es Ihnen, die Verwendung von Cookies auf unserer
          Website zu kontrollieren. Sie können Ihre Einstellungen jederzeit ändern.
        </p>
      </section>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              <input
                ...
                onChange={(e) => handleSettingChange("funktional", e.target.checked)}
                className="w-4 h-4 text-hauptblau bg-weiss border-dunkelgrau rounded focus:ring-hauptblau"
              />
            </div>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              <input
                ...
                onChange={(e) => handleSettingChange("analytik", e.target.checked)}
                className="w-4 h-4 text-hauptblau bg-weiss border-dunkelgrau rounded focus:ring-hauptblau"
              />
            </div>
          </div>
