      ...
      <header className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Textverwaltung</h1>
              <p className="text-gray-600">Alle Website-Texte verwalten und bearbeiten</p>
            </div>
            <button
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {showAddForm && (
          <div className="mb-8 bg-white p-6 rounded-lg shadow">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Neuen Text hinzufügen</h2>
            <form onSubmit={addText} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    value={newText.modul}
                    onChange={(e) => setNewText({ ...newText, modul: e.target.value })}
                    placeholder="z.B. home, leistungen, kontakt"
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">Feld</label>
                  <input
                    type="text"
                    required
                    value={newText.feld}
                    onChange={(e) => setNewText({ ...newText, feld: e.target.value })}
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setNewText({ ...newText, sprache: e.target.value })}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={(e) => setNewText({ ...newText, inhalt: e.target.value })}
                  rows={4}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                />
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={(e) => setFilter({ ...filter, sprache: e.target.value })}
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
