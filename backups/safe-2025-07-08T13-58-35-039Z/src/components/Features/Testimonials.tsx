    ...
    <section className="py-16 bg-gradient-to-br from-dunkelgrau via-hauptblau to-dunkelgrau">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-weiss mb-4">Was unsere Kunden sagen</h2>
        ...
        <div className="text-center mt-6">
          ...
          >
            ...
            <span className="text-akzentblau">{isAutoPlaying ? "⏸️" : "▶️"}</span>
          </button>
        </div>
        ...
        <div className="text-center mt-12">
          <p className="text-hellgrau mb-4">Werden Sie Teil unserer Erfolgsgeschichten</p>
