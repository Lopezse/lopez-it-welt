...
interface SchaltflaecheEigenschaften extends React.ButtonHTMLAttributes<HTMLButtonElement> {
...
export const Schaltflaeche = React.forwardRef<HTMLButtonElement, SchaltflaecheEigenschaften>(
  (
    {
      className,
      variante = "haupt",
...
Schaltflaeche.displayName = "Schaltflaeche";
