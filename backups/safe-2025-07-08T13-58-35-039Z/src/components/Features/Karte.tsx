...
export const KarteKopfzeile: React.FC<KarteKopfzeileEigenschaften> = ({ children, className }) => {
...
export const KarteInhalt: React.FC<KarteInhaltEigenschaften> = ({ children, className }) => {
...
export const KarteFusszeile: React.FC<KarteFusszeileEigenschaften> = ({ children, className }) => {
  return (
