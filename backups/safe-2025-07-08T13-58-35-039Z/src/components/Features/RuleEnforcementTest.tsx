...
export default function RuleEnforcementTest() {
  const { isBlocked, violationCount, lastViolation, checkRules } = useRuleEnforcementHook();
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-lg max-w-4xl mx-auto">
      <h2 className="text-2xl font-bold text-gray-900 mb-6">🛡️ Rule Enforcement System Test</h2>
      ...
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
        <h3 className="text-lg font-semibold text-gray-900 mb-2">Test-Ergebnisse:</h3>
      ...
      <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
        <h3 className="text-lg font-semibold text-yellow-800 mb-2">ℹ️ Anleitung:</h3>
        <ul className="text-sm text-yellow-700 space-y-1">
          <li>
            • <strong>Blockierung testen:</strong> Prüft verschiedene Aktionen gegen die Regeln
          </li>
          <li>
            • <strong>Freigabe testen:</strong> Simuliert eine Aktion, die Freigabe benötigt
          </li>
          <li>
            • <strong>Status anzeigen:</strong> Zeigt den aktuellen Blockierungsstatus
          </li>
          <li>• Bei Blockierung erscheint ein Overlay - Sie müssen explizit freigeben</li>
        </ul>
      </div>
    </div>
  );
