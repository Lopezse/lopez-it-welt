...
const services: Service[] = [
  ...
  },
  {
    ...
    features: ["Bewerbungsvorlagen", "Sicherheits-Tools", "Einmalzahlung", "Sofort-Download"],
  },
];
    ...
    <section className="py-16 bg-gradient-to-br from-dunkelgrau via-hauptblau to-dunkelgrau">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-12 mb-12">
          <h2 className="text-4xl font-bold text-white mb-4">Unsere Kernleistungen</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <Card
              key={index}
              className="min-h-[320px] rounded-2xl shadow-2xl bg-weiss/10 border border-weiss/20 hover:bg-weiss/20 hover:shadow-inner hover:scale-[1.01] transition-all transition-transform duration-300 sm:p-4 md:p-6 lg:p-8 flex flex-col justify-between cursor-pointer"
              tabIndex={0}
                ...
                <ul className="text-left space-y-2">
                  {service.features.map((feature, featureIndex) => (
                    <li key={featureIndex} className="flex items-center text-sm text-gray-200">
                      <span className="text-gruen-aa mr-2">✔️</span>
                      {feature}
                    </li>
                  ))}
                </ul>
        ...
        <div className="text-center mt-12">
          ...
          <button
            className="px-8 py-4 text-lg font-semibold bg-akzentblau text-white rounded-2xl shadow-2xl hover:bg-akzentblau/80 transition-colors focus:outline-none focus:ring-4 focus:ring-weiss/80 focus:ring-offset-2 focus:ring-offset-akzentblau"
            style={{ minWidth: 220 }}
          >
            Beratung anfordern
          </button>
