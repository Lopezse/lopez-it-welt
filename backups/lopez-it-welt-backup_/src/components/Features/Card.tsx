...
export const CardHeader: React.FC<CardHeaderEigenschaften> = ({
  children,
  className,
}) => {
...
export const CardContent: React.FC<CardContentEigenschaften> = ({
  children,
  className,
}) => {
...
export const CardFooter: React.FC<CardFooterEigenschaften> = ({
  children,
  className,
}) => {
  return (
