                    ...
                    <div className='flex items-center justify-between'>
                        ...
                        <div className='flex space-x-2'>
                            {[
                                ...
                                { key: 'kritisch', label: 'Kritisch', count: statistiken.kritisch },
                                {
                                ...
                                <button
                                    ...
                                    className={`px-4 py-2 rounded-lg font-medium transition-all duration-300 ${filter === filterOption.key
