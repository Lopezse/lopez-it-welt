          ...
          <div className='flex items-center justify-between'>
            ...
            <div className='text-right'>
              <div className='backdrop-blur-sm bg-weiss/10 rounded-xl p-4 border border-weiss/20'>
                <p className='text-sm text-hellgrau mb-1'>
                  Letzter Security-Scan
                </p>
                <p className='text-xl font-semibold text-weiss'>
                  {stats.lastScan}
                </p>
              </div>
            </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
          <div className='backdrop-blur-xl bg-weiss/10 rounded-2xl border border-weiss/20 p-6 shadow-2xl'>
            ...
            <div className='space-y-3'>
              <div className='flex justify-between'>
                ...
                <span className='text-weiss font-bold'>
                  {stats.totalAttacks}
                </span>
              </div>
              <div className='flex justify-between'>
                <span className='text-hellgrau'>Blockiert:</span>
                <span className='text-gruen font-bold'>
              ...
              <div className='flex justify-between'>
                ...
                <span className='text-akzentblau font-bold'>
                  {Math.round(
                    (stats.blockedAttacks / stats.totalAttacks) * 100
                  )}
                  %
                </span>
              </div>
          ...
          <div className='backdrop-blur-xl bg-weiss/10 rounded-2xl border border-weiss/20 p-6 shadow-2xl'>
            ...
            <div className='space-y-3'>
              ...
              <div className='text-center text-sm text-hellgrau'>
                  ...
                  <div className='flex items-center space-x-4'>
                    ...
                    <div>
                      ...
                      <div className='text-sm text-hellgrau space-y-1'>
                        <div>
                          Quelle:{' '}
                          <span className='text-weiss'>{event.source}</span>
                        </div>
                        <div>
                          Ziel:{' '}
                          <span className='text-weiss'>{event.target}</span>
                        </div>
                        <div>
                          Zeit:{' '}
                          <span className='text-weiss'>{event.timestamp}</span>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div className='backdrop-blur-xl bg-weiss/10 rounded-2xl border border-weiss/20 p-8 shadow-2xl'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            <div className='backdrop-blur-sm bg-gelb/10 rounded-xl border border-gelb/20 p-4'>
              <h3 className='text-lg font-bold text-gelb mb-2'>
                ⚠️ Kritische Vulnerabilities
              </h3>
              <p className='text-sm text-hellgrau mb-3'>
                7 kritische Sicherheitslücken gefunden
              </p>
            ...
            <div className='backdrop-blur-sm bg-akzentblau/10 rounded-xl border border-akzentblau/20 p-4'>
              <h3 className='text-lg font-bold text-akzentblau mb-2'>
                🛡️ Firewall-Optimierung
              </h3>
              <p className='text-sm text-hellgrau mb-3'>
                156 aktive Firewall-Regeln
              </p>
            ...
            <div className='backdrop-blur-sm bg-gruen/10 rounded-xl border border-gruen/20 p-4'>
              <h3 className='text-lg font-bold text-gruen mb-2'>
                ✅ Backup-Status
              </h3>
              <p className='text-sm text-hellgrau mb-3'>
