...
class SafeBackup {
  ...
  checkDiskSpace() {
    // Ursprüngliche Implementierung war fehlerhaft und prüfte nicht den freien Speicherplatz.
    // Bis zur Implementierung einer echten Speicherplatzprüfung wird immer true zurückgegeben.
    // Siehe Doku-Update in 06-05-admin-backup-system.md
    return true;
  }
