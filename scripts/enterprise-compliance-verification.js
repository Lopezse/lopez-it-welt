...
class EnterpriseComplianceVerification {
    ...
    testComplianceFiles() {
        ...
        this.addResult('Compliance-Dateien', passed, complianceFiles.length, details);
    }
    ...
    generateFinalReport() {
        ...
        fs.writeFileSync('data/final-enterprise-compliance-report.json', JSON.stringify(report, null, 2));
