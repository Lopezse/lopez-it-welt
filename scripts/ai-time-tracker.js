 ...
 *
 * Verwendung:
 * node scripts/ai-time-tracker.js start-ai "KI-Chat Session" "Code-Review mit Cursor"
 * node scripts/ai-time-tracker.js start-auto "CI/CD Pipeline" "Automatisierung von Tests"
 * node scripts/ai-time-tracker.js stop <session-id>
...
function showHelp() {
  console.log(`
🤖 AI Time Tracker - KI & Automatisierung Zeiterfassung

Verwendung:
  node scripts/ai-time-tracker.js <command> [options]
...
Beispiele:
  node scripts/ai-time-tracker.js start-ai "Cursor-Chat" "Code-Review und Bugfix"
  node scripts/ai-time-tracker.js start-auto "CI-Pipeline" "Automatisierte Tests"
  node scripts/ai-time-tracker.js stop 1
  node scripts/ai-time-tracker.js ai-report
`);
}
