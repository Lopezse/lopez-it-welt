(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/node_modules_3eb69887._.js",
"[project]/node_modules/@phc/format/index.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
function objectKeys(object) {
    /* istanbul ignore next */ return Object.keys(object);
}
function objectValues(object) {
    /* istanbul ignore next */ if (typeof Object.values === 'function') return Object.values(object);
    /* istanbul ignore next */ return objectKeys(object).map((k)=>object[k]);
}
/**
 ...
 */ function serialize(opts) {
    ...
    if (typeof opts.params !== 'undefined') {
        ...
        pk.forEach((k)=>{
            ...
            } else if (__TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"].isBuffer(opts.params[k])) {
    ...
    if (typeof opts.salt !== 'undefined') {
        // Salt Validation
        if (!__TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"].isBuffer(opts.salt)) {
            throw new TypeError('salt must be a Buffer');
        }
        fields.push(opts.salt.toString('base64').split('=')[0]);
        if (typeof opts.hash !== 'undefined') {
            // Hash Validation
            if (!__TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"].isBuffer(opts.hash)) {
 ...
 */ function deserialize(phcstr) {
    ...
    if (b64Regex.test(fields[fields.length - 1])) {
        if (fields.length > 1 && b64Regex.test(fields[fields.length - 2])) {
            // Parse Hash
            hash = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"].from(fields.pop(), 'base64');
            // Parse Salt
            salt = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"].from(fields.pop(), 'base64');
        } else {
            // Parse Salt
            salt = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"].from(fields.pop(), 'base64');
        }
...
"[project]/node_modules/argon2/argon2.cjs [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
const { deserialize, serialize } = __turbopack_context__.r("[project]/node_modules/@phc/format/index.js [middleware-edge] (ecmascript)");
const gypBuild = __turbopack_context__.r("[project]/node_modules/node-gyp-build/index.js [middleware-edge] (ecmascript)");
const { hash: bindingsHash } = gypBuild(("TURBOPACK compile-time value", "/ROOT/node_modules/argon2"));
/** @type {(size: number) => Promise<Buffer>} */ const generateSalt = promisify(randomBytes);
const argon2d = 0;
const argon2i = 1;
const argon2id = 2;
...
/** @enum {argon2i | argon2d | argon2id} */ const types = Object.freeze({
    argon2d,
    argon2i,
    argon2id
});
/** @enum {'argon2d' | 'argon2i' | 'argon2id'} */ const names = Object.freeze({
 ...
 */ async function hash(password, options) {
    ...
    const { hashLength, secret = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"].alloc(0), type, version, memoryCost: m, timeCost: t, parallelism: p, associatedData: data = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"].alloc(0) } = rest;
    const hash = await bindingsHash({
        password: __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"].from(password),
        salt,
        secret,
        data,
        hashLength,
 ...
 */ function needsRehash(digest, options = {}) {
    ...
    const { version: v, params: { m, t, p } } = deserialize(digest);
 ...
 */ async function verify(digest, password, options = {}) {
    ...
    const { version = 0x10, params: { m, t, p, data = "" }, salt, hash } = rest;
    const { secret = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"].alloc(0) } = options;
...
"[project]/node_modules/named-placeholders/node_modules/lru-cache/index.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
function createCompiler(config) {
    ...
    if (config.cache !== false && !cache) {
        cache = new (__turbopack_context__.r("[project]/node_modules/named-placeholders/node_modules/lru-cache/index.js [middleware-edge] (ecmascript)"))({
            max: ncache
        });
    }
...
//# sourceMappingURL=node_modules_3eb69887._.js.map