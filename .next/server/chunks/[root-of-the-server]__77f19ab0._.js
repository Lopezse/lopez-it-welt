module.exports = [
"[project]/.next-internal/server/app/api/admin/ai/models/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/admin/ai/models/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const risk_category = searchParams.get("risk_category");
        const models = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$ai$2d$model$2d$registry$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIModelRegistry"].listModels({
            status: status || undefined,
            provider: provider || undefined,
            risk_category: risk_category || undefined
        });
        // Compliance-Warnungen
        const warnings = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$ai$2d$model$2d$registry$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIModelRegistry"].getComplianceWarnings();
        // Summary
        const summary = {
            total: models.length,
            by_status: {
...
async function POST(request) {
    try {
        ...
        if (!body.code || !body.name || !body.provider || !body.risk_category) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: "code, name, provider und risk_category sind erforderlich"
            }, {
                status: 400
            });
        }
        const model = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$ai$2d$model$2d$registry$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIModelRegistry"].registerModel({
            code: body.code,
            name: body.name,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__77f19ab0._.js.map