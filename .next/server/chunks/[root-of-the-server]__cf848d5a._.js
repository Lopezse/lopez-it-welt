...
"[project]/src/lib/customer/auth-service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const ARGON2_OPTIONS = {
    type: __TURBOPACK__imported__module__$5b$externals$5d2f$argon2__$5b$external$5d$__$28$argon2$2c$__cjs$29$__["argon2id"],
    memoryCost: 65536,
    timeCost: 3,
    parallelism: 4,
...
class CustomerAuthService {
   ...
   */ static async hashPassword(password) {
        return __TURBOPACK__imported__module__$5b$externals$5d2f$argon2__$5b$external$5d$__$28$argon2$2c$__cjs$29$__["hash"](password, ARGON2_OPTIONS);
    }
    /**
   * Verifiziert ein Passwort gegen einen Hash
   */ static async verifyPassword(password, hash) {
        try {
            return await __TURBOPACK__imported__module__$5b$externals$5d2f$argon2__$5b$external$5d$__$28$argon2$2c$__cjs$29$__["verify"](hash, password);
        } catch  {
            return false;
        }
    }
   ...
   */ static async register(input) {
        ...
        try {
            ...
            const [existing] = await pool.execute("SELECT id FROM lopez_customers WHERE email = ?", [
   ...
   */ static async verifyEmail(token) {
    ...
    /**
   * Login eines Kunden
   */ static async login(input, ip, userAgent) {
        const pool = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getConnection"])();
        try {
            // Kunde suchen
   ...
   */ static async validateSession(token) {
      ...
      `, [
            ...
            return {
                valid: true,
                customer_id: sessions[0].customer_id
            };
        } catch  {
            return {
                valid: false
   ...
   */ static async logout(token) {
        const pool = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getConnection"])();
        try {
            await pool.execute("DELETE FROM lopez_customer_sessions WHERE token = ?", [
                token
            ]);
            return true;
        } catch  {
...
const __TURBOPACK__default__export__ = CustomerAuthService;
}),
"[project]/src/lib/customer/email-service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const __TURBOPACK__default__export__ = CustomerEmailService;
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$customer$2f$auth$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/customer/auth-service.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$customer$2f$email$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/customer/email-service.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/database.ts [app-route] (ecmascript)");
;
;
;
...
async function POST(request) {
    try {
        ...
        const { email, password, password_confirm, first_name, last_name, company_name, dsgvo_consent, marketing_consent } = body;
        // -------------------------------------------------
        // VALIDIERUNG
        // -------------------------------------------------
        // Pflichtfelder
        ...
        // REGISTRIERUNG
        // -------------------------------------------------
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$customer$2f$auth$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CustomerAuthService"].register({
            email,
            password,
            first_name,
            last_name,
        ...
        if (result.verification_token) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$customer$2f$email$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["CustomerEmailService"].sendVerificationEmail(email, result.verification_token, first_name || "Kunde");
        }
        // -------------------------------------------------
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cf848d5a._.js.map