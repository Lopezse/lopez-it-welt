module.exports = [
"[project]/.next-internal/server/app/api/admin/ai/monitoring/health/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/admin/ai/monitoring/health/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function checkAgentRegistry() {
    ...
    try {
        const pool = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getConnection"])();
        const [rows] = await pool.execute("SELECT COUNT(*) as count, SUM(enabled) as enabled FROM ai_agents");
...
async function checkDSGVOEngine() {
    const start = Date.now();
    try {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__647ea5e7._.js.map