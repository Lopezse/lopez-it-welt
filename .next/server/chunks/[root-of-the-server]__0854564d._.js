module.exports = [
"[project]/.next-internal/server/app/api/customer/init-tables/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/customer/init-tables/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    ...
    `);
        ...
        const missingColumns = [
            ...
            {
                name: 'country',
                definition: "VARCHAR(50) DEFAULT 'DE'",
                after: 'postal_code'
            },
            {
                name: 'status',
                definition: "ENUM('pending', 'active', 'suspended', 'deleted') DEFAULT 'pending'",
                after: 'country'
            },
            {
                name: 'email_verified',
            ...
            },
            {
                ...
                definition: 'BOOLEAN DEFAULT FALSE',
                after: 'dsgvo_consent_at'
            },
            // Onboarding-spezifische Spalten
            {
                name: 'salutation',
                definition: "ENUM('herr', 'frau', 'divers', 'firma') DEFAULT 'herr'",
                after: 'id'
            },
            {
                name: 'language',
                definition: "ENUM('de', 'en', 'es') DEFAULT 'de'",
                after: 'phone'
            },
            {
                name: 'agb_accepted',
            ...
            },
            {
                ...
                definition: 'BOOLEAN DEFAULT FALSE',
                after: 'agb_accepted_at'
            },
            {
                name: 'datenschutz_accepted_at',
                definition: 'TIMESTAMP NULL',
                after: 'datenschutz_accepted'
            },
            {
                name: 'ai_processing_accepted',
                definition: 'BOOLEAN DEFAULT FALSE',
                after: 'datenschutz_accepted_at'
            },
            {
                name: 'service_interests',
                definition: 'JSON',
                after: 'ai_processing_accepted'
            },
            {
                name: 'referral_source',
                definition: 'VARCHAR(50)',
                after: 'service_interests'
            },
            {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0854564d._.js.map