module.exports = [
"[project]/.next-internal/server/app/api/admin/ai/playbooks/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/lib/ai-center/playbook-service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class PlaybookService {
   ...
   */ static async initializeDefaultPlaybooks() {
   ...
   */ static async upsertPlaybook(playbook) {
    ...
    `, [
      ...
      `, [
            ...
            return this.getPlaybookByCode(playbook.code);
        }
        // Insert
    ...
    `, [
        ...
        return this.getPlaybookById(result.insertId);
    }
    /**
   ...
   */ static async getPlaybookByCode(code) {
        const pool = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getConnection"])();
        const [rows] = await pool.execute(`
   ...
   */ static async listPlaybooks(filters) {
        const pool = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getConnection"])();
   ...
   */ static async executePlaybook(playbookId, context, options = {}) {
        const pool = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getConnection"])();
        // Playbook laden
        const playbook = typeof playbookId === 'number' ? await this.getPlaybookById(playbookId) : await this.getPlaybookByCode(playbookId);
        if (!playbook) {
   ...
   */ static async executeStep(step, context, dryRun) {
        if (dryRun) {
            return {
                status: "simulated",
   ...
   */ static async getExecutionById(id) {
    ...
    /**
   * Listet Executions
   */ static async listExecutions(playbookId, limit = 50) {
        const pool = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getConnection"])();
...
const __TURBOPACK__default__export__ = PlaybookService;
}),
"[project]/src/app/api/admin/ai/playbooks/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$playbook$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/ai-center/playbook-service.ts [app-route] (ecmascript)");
;
;
async function GET(request) {
    try {
        ...
        const playbooks = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$playbook$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PlaybookService"].listPlaybooks({
...
async function POST(request) {
    try {
        ...
        if (!body.code || !body.name || !body.category || !body.steps) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: "code, name, category und steps sind erforderlich"
            }, {
                status: 400
            });
        }
        const playbook = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$playbook$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PlaybookService"].upsertPlaybook({
            code: body.code,
            name: body.name,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__865699ff._.js.map