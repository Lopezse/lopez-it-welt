module.exports = [
"[project]/.next-internal/server/app/api/admin/ki-sessions/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/admin/ki-sessions/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const KI_SESSIONS_FILE = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), "data", "ki-sessions.json");
// KI-Sessions laden
async function loadKISessions() {
    try {
        const data = await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].readFile(KI_SESSIONS_FILE, "utf-8");
...
async function saveKISessions(sessions) {
    try {
        // Verzeichnis erstellen falls nicht vorhanden
        const dir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].dirname(KI_SESSIONS_FILE);
        await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].mkdir(dir, {
            recursive: true
        });
        await __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["promises"].writeFile(KI_SESSIONS_FILE, JSON.stringify(sessions, null, 2));
    } catch (error) {
...
async function PUT(request) {
    try {
        ...
        await saveKISessions(sessions);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(updatedSession);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f576c220._.js.map