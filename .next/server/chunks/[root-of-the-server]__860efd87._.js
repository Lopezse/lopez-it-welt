module.exports = [
"[project]/.next-internal/server/app/api/admin/ai/risk-to-task/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/admin/ai/risk-to-task/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ function mapRiskTypeToTaskType(riskType) {
    const mapping = {
        "security": "security",
        "sec": "security",
 ...
 */ function generateTaskTitle(riskType, riskTitle) {
    const prefixes = {
        "security": "[SEC]",
        "performance": "[PERF]",
        "accessibility": "[A11Y]",
    ...
    const cleanTitle = riskTitle.length > 80 ? riskTitle.substring(0, 77) + "..." : riskTitle;
    return `${prefix} ${cleanTitle}`;
}
/**
 * Generiert Task-Beschreibung aus Risiko
 */ function generateTaskDescription(request) {
...
async function POST(request) {
    try {
        ...
        const pool = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getConnection"])();
        try {
            const [existing] = await pool.execute(`SELECT id FROM dev_tasks WHERE description LIKE ?`, [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__860efd87._.js.map