module.exports = [
"[project]/.next-internal/server/app/api/admin/ai/init-hardening/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/admin/ai/init-hardening/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    ...
    `);
        ...
        for (const [key, value] of Object.entries(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$settings$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DEFAULT_SETTINGS"])){
            try {
                await pool.execute(`
    ...
    `);
        ...
        const [agentCount] = await pool.execute(`
    ...
    `);
        ...
        const [playbookCount] = await pool.execute(`
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1702dee7._.js.map