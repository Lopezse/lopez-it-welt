module.exports = [
"[project]/.next-internal/server/app/api/admin/ai/reports/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/lib/ai/ai-provider.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class AIProvider {
   ...
   */ static async generate(request) {
    ...
    /**
   * OpenAI API Anfrage
   */ static async generateOpenAI(request, model, startTime) {
   ...
   */ static async generateDemoResponse(request, provider, model, startTime) {
   ...
   */ static generateDemoContent(prompt, systemPrompt) {
...
In der Produktionsumgebung werden echte AI-Modelle verwendet.`;
   ...
   */ static async logUsage(usage) {
        try {
            ...
            await pool.execute(`INSERT INTO lopez_ai_usage 
   ...
   */ static async getUsageStats(days = 30) {
        try {
         ...
         WHERE created_at > DATE_SUB(NOW(), INTERVAL ? DAY)`, [
            ...
            const [byProvider] = await pool.execute(`SELECT provider, COUNT(*) as count 
         FROM lopez_ai_usage 
         WHERE created_at > DATE_SUB(NOW(), INTERVAL ? DAY)
         GROUP BY provider`, [
                days
            ]);
            const [byEndpoint] = await pool.execute(`SELECT endpoint, COUNT(*) as count 
         FROM lopez_ai_usage 
         WHERE created_at > DATE_SUB(NOW(), INTERVAL ? DAY)
         GROUP BY endpoint`, [
                days
...
const __TURBOPACK__default__export__ = AIProvider;
}),
"[project]/src/lib/ai/ai-insights-service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/database.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2f$ai$2d$provider$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/ai/ai-provider.ts [app-route] (ecmascript)");
;
;
class AIInsightsService {
   ...
   */ static async generateCustomerInsights(customerId, userId) {
        try {
            const pool = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getConnection"])();
            // Kundendaten laden
            const [customerRows] = await pool.execute(`SELECT c.*, 
         ...
         FROM lopez_customers c WHERE c.id = ?`, [
            ...
            // Notizen laden
            const [notes] = await pool.execute("SELECT * FROM lopez_customer_notes WHERE customer_id = ? ORDER BY created_at DESC LIMIT 10", [
                customerId
            ]);
            // AI-Prompt erstellen
...
Antworte auf Deutsch. Verwende Markdown-Formatierung.`;
            // AI-Anfrage
            const aiResponse = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2f$ai$2d$provider$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIProvider"].generate({
                prompt,
                systemPrompt,
                userId,
            ...
            // Insight speichern
            const [result] = await pool.execute(`INSERT INTO lopez_ai_customer_insights 
         ...
         VALUES (?, 'summary', ?, 0.85, ?, ?, ?, ?, ?)`, [
            ...
            return {
                success: false,
                insights: [],
                error: "Fehler bei der Kundenanalyse"
            };
        }
    }
    /**
   ...
   */ static async getCustomerInsights(customerId) {
        try {
            const pool = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getConnection"])();
            const [rows] = await pool.execute(`SELECT * FROM lopez_ai_customer_insights 
         WHERE customer_id = ? 
   ...
   */ static async generateProjectInsights(projectId, userId) {
        try {
            const pool = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getConnection"])();
            // Projektdaten laden
            const [projectRows] = await pool.execute(`SELECT p.*, 
...
Antworte auf Deutsch. Verwende Markdown-Formatierung.`;
            ...
            // Insight speichern
            await pool.execute(`INSERT INTO lopez_ai_project_insights 
         ...
         VALUES (?, 'summary', ?, 0.85, ?, ?, ?, ?, ?)`, [
            ...
            return {
                success: false,
                insights: [],
                error: "Fehler bei der Projektanalyse"
            };
        }
    }
    /**
   * Lädt vorhandene Project Insights
   */ static async getProjectInsights(projectId) {
        try {
            const pool = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getConnection"])();
            const [rows] = await pool.execute(`SELECT * FROM lopez_ai_project_insights 
         WHERE project_id = ? 
         ORDER BY created_at DESC`, [
                projectId
            ]);
   ...
   */ static async generateProjectInsightsExtended(projectId, userId, analysisTypes) {
        try {
            const pool = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getConnection"])();
         ...
         WHERE p.id = ?`, [
            ...
            const selectedAnalyses = analysisTypes.filter((t)=>analysisLabels[t]).map((t)=>analysisLabels[t]);
            // =====================================================
            ...
            // =====================================================
            const taskProgress = project.task_count > 0 ? Math.round(project.tasks_done / project.task_count * 100) : 0;
            ...
            if (project.end_date) {
                ...
                daysUntilDeadline = diffDays > 0 ? `${diffDays} Tage verbleibend` : diffDays === 0 ? "Heute fällig!" : `${Math.abs(diffDays)} Tage überfällig!`;
            }
            const prompt = `
...
Sei präzise, professionell und action-orientiert.`;
         ...
         LIMIT 5`, [
            ...
            return {
                success: false,
                insights: [],
                error: "Fehler bei der erweiterten Projektanalyse"
            };
        }
    }
    // =====================================================
   ...
   */ static async checkInvoice(invoiceId, userId) {
        try {
            const pool = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getConnection"])();
            // Rechnungsdaten laden
            const [invoiceRows] = await pool.execute(`SELECT i.*, 
         ...
         WHERE i.id = ?`, [
            ...
            // Positionen laden
            const [items] = await pool.execute("SELECT * FROM lopez_invoice_items WHERE invoice_id = ?", [
                invoiceId
            ]);
...
**Positionen:**
${items.map((item)=>`- ${item.description}: ${item.quantity}x ${item.unit_price}€ = ${item.gross_amount}€`).join("\n") || "Keine Positionen"}
...
Antworte auf Deutsch. Verwende Markdown-Formatierung.`;
            ...
            // Insight speichern
            await pool.execute(`INSERT INTO lopez_ai_invoice_insights 
         ...
         VALUES (?, 'check', ?, 'info', ?, ?, ?, ?, ?)`, [
            ...
            return {
                success: false,
                insights: [],
                error: "Fehler bei der Rechnungsprüfung"
            };
        }
    }
    /**
   * Lädt vorhandene Invoice Insights
   */ static async getInvoiceInsights(invoiceId) {
        try {
            const pool = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getConnection"])();
            const [rows] = await pool.execute(`SELECT * FROM lopez_ai_invoice_insights 
         WHERE invoice_id = ? 
         ORDER BY created_at DESC`, [
                invoiceId
            ]);
   ...
   */ static async generateReport(reportType, userId) {
        try {
            const pool = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getConnection"])();
            ...
            // Kunden-Statistiken
            const [customerStats] = await pool.execute(`SELECT COUNT(*) as total, 
                SUM(CASE WHEN created_at > ? THEN 1 ELSE 0 END) as new_count
         FROM lopez_customers`, [
                periodStart
            ]);
            dataSnapshot.customers = customerStats[0];
            // Projekt-Statistiken
            const [projectStats] = await pool.execute(`SELECT COUNT(*) as total,
                SUM(CASE WHEN status = 'in_progress' THEN 1 ELSE 0 END) as active,
                SUM(CASE WHEN status = 'done' AND updated_at > ? THEN 1 ELSE 0 END) as completed
         FROM lopez_projects`, [
                periodStart
            ]);
            dataSnapshot.projects = projectStats[0];
            // Rechnungs-Statistiken
            const [invoiceStats] = await pool.execute(`SELECT COUNT(*) as total,
         ...
         FROM lopez_invoices WHERE issue_date > ?`, [
            ...
            dataSnapshot.invoices = invoiceStats[0];
            // Security-Statistiken
            const [securityStats] = await pool.execute(`SELECT COUNT(*) as total_events,
                SUM(CASE WHEN risk_level IN ('high', 'critical') THEN 1 ELSE 0 END) as high_risk
         FROM lopez_security_events WHERE created_at > ?`, [
                periodStart
            ]);
            dataSnapshot.security = securityStats[0];
            // Report-Prompt
            const prompt = `
...
Antworte auf Deutsch. Verwende klare Struktur und Markdown-Formatierung.`;
            ...
            const [result] = await pool.execute(`INSERT INTO lopez_ai_reports 
         ...
         VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`, [
            ...
            return {
                success: false,
                error: "Fehler bei der Report-Generierung"
            };
        }
    }
    /**
   * Lädt vorhandene Reports
   */ static async getReports(limit = 20) {
        try {
            const pool = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getConnection"])();
            const [rows] = await pool.execute(`SELECT * FROM lopez_ai_reports ORDER BY generated_at DESC LIMIT ?`, [
                limit
            ]);
            return rows;
        } catch (error) {
...
const __TURBOPACK__default__export__ = AIInsightsService;
}),
"[project]/src/app/api/admin/ai/reports/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2f$ai$2d$insights$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/ai/ai-insights-service.ts [app-route] (ecmascript)");
;
;
async function GET(request) {
    try {
        ...
        const reports = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2f$ai$2d$insights$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIInsightsService"].getReports(limit);
...
async function POST(request) {
    try {
        ...
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2f$ai$2d$insights$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AIInsightsService"].generateReport(reportType, userId);
        if (!result.success) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: result.error
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e022dddb._.js.map