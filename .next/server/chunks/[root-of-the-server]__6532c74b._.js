module.exports = [
"[project]/.next-internal/server/app/api/admin/ai/agents/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/admin/ai/agents/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const [existing] = await pool.execute(`SELECT id FROM ai_agents WHERE name = ?`, [
            name
        ]);
        if (existing.length > 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: `Agent "${name}" existiert bereits`
            }, {
                status: 409
            });
        }
    ...
    `, [
        ...
        // Neuen Agent laden
        const [rows] = await pool.execute(`SELECT * FROM ai_agents WHERE id = ?`, [
            agentId
        ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6532c74b._.js.map