module.exports = [
"[project]/.next-internal/server/app/api/admin/dev-tasks/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/lib/dev-orchestrator/agent-a-planner.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class AgentAPlanner {
   ...
   */ static async planTask(task) {
        console.log(`[Agent-A] Starte Planung für Task #${task.id}: ${task.title}`);
        try {
            // Task-Status auf "planning" setzen
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dev$2d$tasks$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DevTasksService"].updateTaskStatus(task.id, "planning");
            // AI Provider holen
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dev$2d$tasks$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DevTasksService"].saveStepsForTask(task.id, planData.steps.map((step)=>({
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dev$2d$tasks$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DevTasksService"].updateTaskStatus(task.id, "planned");
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dev$2d$tasks$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DevTasksService"].updateTaskStatus(task.id, "open");
            return {
                success: false,
                task_id: task.id,
                steps: [],
...
Antworte mit JSON.`;
   ...
   */ static async createMockPlan(task) {
        ...
        switch(task.type){
            case "bug":
                mockSteps.push({
                    ...
                    details: "Den gemeldeten Fehler in der Entwicklungsumgebung reproduzieren.",
                    estimated_effort: "30min"
                }, {
                    step_number: 2,
                    title: "Ursache analysieren",
                    details: "Root Cause Analysis durchführen, Logs und Stack Traces prüfen.",
                    estimated_effort: "1h"
                }, {
                    step_number: 3,
                    title: "Fix implementieren",
                    details: "Den Fehler beheben ohne Seiteneffekte.",
                    estimated_effort: "2h"
                }, {
                    step_number: 4,
                    title: "Regression-Test",
                    details: "Sicherstellen dass der Fix funktioniert und nichts anderes kaputt macht.",
                    estimated_effort: "30min"
                });
                break;
            case "feature":
                mockSteps.push({
                    ...
                    details: "Genaue Anforderungen und Akzeptanzkriterien definieren.",
                    estimated_effort: "1h"
                }, {
                    step_number: 2,
                    title: "Technisches Design",
                    details: "Architektur und Datenmodell planen.",
                    estimated_effort: "1h"
                }, {
                    step_number: 3,
                    title: "Backend implementieren",
                    details: "API und Datenbanklogik umsetzen.",
                    estimated_effort: "4h"
                }, {
                    step_number: 4,
                    title: "Frontend implementieren",
                    details: "UI-Komponenten und Integration.",
                    estimated_effort: "4h"
                }, {
                    step_number: 5,
                    title: "Tests schreiben",
                    details: "Unit- und Integrationstests.",
                    estimated_effort: "2h"
                });
                break;
            case "refactor":
                mockSteps.push({
                    ...
                    details: "Aktuellen Code verstehen und Probleme identifizieren.",
                    estimated_effort: "1h"
                }, {
                    step_number: 2,
                    title: "Tests sicherstellen",
                    details: "Bestehende Tests prüfen, ggf. ergänzen.",
                    estimated_effort: "1h"
                }, {
                    step_number: 3,
                    title: "Refactoring durchführen",
                    details: "Code schrittweise verbessern.",
                    estimated_effort: "2h"
                }, {
                    step_number: 4,
                    title: "Tests ausführen",
                    details: "Alle Tests müssen weiterhin bestehen.",
                    estimated_effort: "30min"
                });
                break;
            default:
                mockSteps.push({
                    step_number: 1,
                    title: "Analyse",
                    details: "Aufgabe analysieren.",
                    estimated_effort: "1h"
                }, {
                    step_number: 2,
                    title: "Umsetzung",
                    details: "Aufgabe umsetzen.",
                    estimated_effort: "2h"
                }, {
                    step_number: 3,
                    title: "Abschluss",
                    details: "Dokumentation und Review.",
                    estimated_effort: "1h"
                });
        }
        // Schritte speichern
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dev$2d$tasks$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DevTasksService"].saveStepsForTask(task.id, mockSteps.map((step)=>({
                step_number: step.step_number,
                title: step.title,
                details: step.details,
                estimated_effort: step.estimated_effort,
...
const __TURBOPACK__default__export__ = AgentAPlanner;
}),
"[project]/src/app/api/admin/dev-tasks/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dev$2d$tasks$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/dev-tasks-service.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dev$2d$orchestrator$2f$agent$2d$a$2d$planner$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/dev-orchestrator/agent-a-planner.ts [app-route] (ecmascript)");
;
;
;
async function GET(request) {
    try {
        ...
        // Statistiken abrufen
        if (view === "stats") {
            const stats = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dev$2d$tasks$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DevTasksService"].getStatistics();
        ...
        if (view === "detail" && taskId) {
            const task = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dev$2d$tasks$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DevTasksService"].getTaskById(parseInt(taskId));
            if (!task) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    success: false,
            ...
            const steps = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dev$2d$tasks$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DevTasksService"].getStepsForTask(task.id);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: true,
                data: {
                    task,
        ...
        // Task-Liste abrufen
        const { tasks, total } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dev$2d$tasks$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DevTasksService"].getTasks({
            limit,
            offset,
...
async function POST(request) {
    try {
        ...
        const taskType = validTypes.includes(body.type) ? body.type : "feature";
        ...
        const task = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dev$2d$tasks$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DevTasksService"].createTask({
            title: body.title,
        ...
        if (startPlanning) {
            ...
            if (useMock) {
                // Mock-Plan für Demo
                planResult = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dev$2d$orchestrator$2f$agent$2d$a$2d$planner$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AgentAPlanner"].createMockPlan(task);
            } else {
                // Echte AI-Planung
                planResult = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dev$2d$orchestrator$2f$agent$2d$a$2d$planner$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AgentAPlanner"].planTask(task);
            }
            console.log("[DEV-TASKS API] Planung abgeschlossen:", planResult.success);
        }
        // Aktualisierter Task mit Steps
        const updatedTask = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dev$2d$tasks$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DevTasksService"].getTaskById(task.id);
        const steps = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dev$2d$tasks$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DevTasksService"].getStepsForTask(task.id);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            message: planResult?.success ? `Task erstellt und ${steps.length} Plan-Schritte generiert` : "Task erstellt",
            data: {
                task: updatedTask,
                steps,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__22533e34._.js.map