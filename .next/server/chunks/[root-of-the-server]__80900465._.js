module.exports = [
"[project]/.next-internal/server/app/api/admin/ai/settings/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/lib/ai-center/settings-service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class AISettingsService {
   ...
   */ static async getSettings() {
      ...
      `);
            ...
            for (const row of rows){
                ...
                if (key in settings) {
                    settings[key] = this.parseValue(row.setting_value, row.value_type);
                }
            }
            // Cache aktualisieren
            this.cache = settings;
   ...
   */ static async getNumericSetting(key) {
        const settings = await this.getSettings();
...
"[project]/src/app/api/admin/ai/settings/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$settings$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/ai-center/settings-service.ts [app-route] (ecmascript)");
;
;
async function GET(request) {
    try {
        const settings = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$settings$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AISettingsService"].getSettings();
        const costStatus = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$settings$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AICostTracker"].checkCostLimit();
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            data: {
                settings,
                cost_status: costStatus,
                defaults: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$settings$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DEFAULT_SETTINGS"]
            }
        });
    } catch (error) {
...
async function PATCH(request) {
    try {
        ...
        if (!body.updates || typeof body.updates !== "object") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: "updates Objekt erforderlich"
            }, {
                status: 400
            });
        }
        // Validierung: Nur bekannte Keys erlauben
        const validKeys = Object.keys(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$settings$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DEFAULT_SETTINGS"]);
        const invalidKeys = Object.keys(body.updates).filter((k)=>!validKeys.includes(k));
        if (invalidKeys.length > 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: `Unbekannte Settings: ${invalidKeys.join(", ")}`
            }, {
                status: 400
            });
        }
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$settings$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AISettingsService"].updateSettings(body.updates);
        const updatedSettings = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$settings$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AISettingsService"].getSettings();
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
...
async function DELETE(request) {
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$settings$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AISettingsService"].resetToDefaults();
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            message: "Settings auf Defaults zurückgesetzt",
            data: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$settings$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DEFAULT_SETTINGS"]
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__80900465._.js.map