module.exports = [
"[project]/.next-internal/server/app/api/admin/ai/init-compliance/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/lib/ai-center/tenant-service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class TenantService {
   ...
   */ static async getTenantByCode(code) {
        const pool = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getConnection"])();
        const [rows] = await pool.execute(`
   ...
   */ static async listTenants(status) {
        const pool = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getConnection"])();
   ...
   */ static async updateTenant(id, updates) {
        ...
        if (updates.cost_limit_daily !== undefined) {
            fields.push("cost_limit_daily = ?");
            values.push(updates.cost_limit_daily);
        }
        if (updates.cost_limit_monthly !== undefined) {
            fields.push("cost_limit_monthly = ?");
            values.push(updates.cost_limit_monthly);
        }
        if (updates.rate_limit_per_minute !== undefined) {
            fields.push("rate_limit_per_minute = ?");
            values.push(updates.rate_limit_per_minute);
        }
        if (updates.features_enabled !== undefined) {
            fields.push("features_enabled = ?");
            values.push(JSON.stringify(updates.features_enabled));
        }
        if (updates.ai_providers_allowed !== undefined) {
            fields.push("ai_providers_allowed = ?");
            values.push(JSON.stringify(updates.ai_providers_allowed));
        }
   ...
   */ static async createProject(tenantId, project) {
        const pool = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getConnection"])();
        const [result] = await pool.execute(`
   ...
   */ static async listProjects(tenantId) {
        const pool = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getConnection"])();
        const [rows] = await pool.execute(`
   ...
   */ static async getTenantContext(tenantCode, userId, projectCode) {
   ...
   */ static async isFeatureEnabled(tenantId, feature) {
   ...
   */ static async isProviderAllowed(tenantId, provider) {
        const tenant = await this.getTenantById(tenantId);
        if (!tenant) return false;
   ...
   */ static async updateTenantCosts(tenantId, cost) {
        const pool = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getConnection"])();
        await pool.execute(`
      UPDATE ai_tenants 
...
const __TURBOPACK__default__export__ = TenantService;
}),
"[project]/src/lib/ai-center/ai-model-registry.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class AIModelRegistry {
   ...
   */ static async registerModel(model) {
    ...
    `, [
            ...
            model.version,
            model.risk_category,
            model.risk_justification,
            model.dsfa_required,
            model.dsfa_document_url || null,
            model.status,
            model.approved_by || null,
            model.approved_at || null,
            model.approval_notes || null,
            JSON.stringify(model.allowed_use_cases),
            JSON.stringify(model.prohibited_use_cases),
            model.requires_human_oversight,
            model.max_autonomy_level,
            JSON.stringify(model.input_types),
            JSON.stringify(model.output_types),
            model.max_tokens,
            model.cost_per_1k_input,
            model.cost_per_1k_output,
            model.gdpr_compliant,
            model.data_processing_location,
            model.data_retention_policy,
            model.documentation_url || null
        ]);
        return this.getModelById(result.insertId);
    }
    /**
   * Holt Modell nach ID
   ...
   */ static async getModelByCode(code) {
        const pool = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getConnection"])();
        const [rows] = await pool.execute(`
   ...
   */ static async updateModelStatus(id, status, approvedBy, notes) {
        const pool = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getConnection"])();
        await pool.execute(`
   ...
   */ static async isUseCaseAllowed(modelCode, useCase) {
        const model = await this.getModelByCode(modelCode);
        if (!model) {
            return {
                allowed: false,
                reason: "Modell nicht registriert"
            };
        }
        if (model.status !== "approved") {
            return {
                allowed: false,
                reason: `Modell-Status: ${model.status}`
            };
        }
        if (model.risk_category === "unacceptable") {
            return {
                allowed: false,
                reason: "Modell ist gemäß EU AI Act nicht erlaubt"
            };
        }
        if (model.prohibited_use_cases.includes(useCase)) {
            return {
                allowed: false,
                reason: `Use-Case '${useCase}' ist für dieses Modell verboten`
            };
        }
        if (!model.allowed_use_cases.includes(useCase) && model.allowed_use_cases.length > 0) {
            return {
                allowed: false,
                reason: `Use-Case '${useCase}' ist nicht explizit erlaubt`
            };
        }
        return {
            allowed: true
   ...
   */ static async getComplianceSummary(modelCode) {
        const model = await this.getModelByCode(modelCode);
        ...
        const checks = [
            ...
            },
            {
                ...
                details: model.dsfa_required ? model.dsfa_document_url ? "DSFA vorhanden" : "DSFA fehlt!" : "Keine DSFA erforderlich"
            },
            {
                check: "Human Oversight",
                passed: true,
                details: model.requires_human_oversight ? "Menschliche Aufsicht erforderlich" : "Vollautomatischer Betrieb möglich"
            },
            {
   ...
   */ static async getComplianceWarnings() {
...
const __TURBOPACK__default__export__ = AIModelRegistry;
}),
"[project]/src/app/api/admin/ai/init-compliance/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$tenant$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/ai-center/tenant-service.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$ai$2d$model$2d$registry$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/ai-center/ai-model-registry.ts [app-route] (ecmascript)");
;
;
;
;
...
async function POST(request) {
    ...
    `);
        ...
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `, [
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$tenant$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DEFAULT_TENANT"].code,
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$tenant$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DEFAULT_TENANT"].name,
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$tenant$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DEFAULT_TENANT"].description,
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$tenant$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DEFAULT_TENANT"].status,
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$tenant$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DEFAULT_TENANT"].cost_limit_daily,
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$tenant$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DEFAULT_TENANT"].cost_limit_monthly,
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$tenant$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DEFAULT_TENANT"].rate_limit_per_minute,
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$tenant$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DEFAULT_TENANT"].storage_limit_mb,
                JSON.stringify(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$tenant$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DEFAULT_TENANT"].features_enabled),
                JSON.stringify(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$tenant$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DEFAULT_TENANT"].ai_providers_allowed),
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$tenant$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DEFAULT_TENANT"].contact_email,
                __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$tenant$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DEFAULT_TENANT"].contact_name
            ]);
        ...
        for (const model of __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$ai$2d$model$2d$registry$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DEFAULT_AI_MODELS"]){
            try {
                await pool.execute(`
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8b173c18._.js.map