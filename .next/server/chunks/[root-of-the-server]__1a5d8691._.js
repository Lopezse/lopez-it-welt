...
async function POST(request) {
    try {
        ...
        const { project_id, customer_id, order_no, title, description, status = "new", sla_priority = "normal", created_by, assigned_to } = body;
        if (!customer_id || !title || !created_by) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: "customer_id, title und created_by sind erforderlich"
            }, {
                status: 400
            });
        }
        const connection = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createConnection"])();
        const [result] = await connection.execute(`INSERT INTO lopez_orders 
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1a5d8691._.js.map