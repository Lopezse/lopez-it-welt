module.exports = [
"[project]/.next-internal/server/app/api/admin/project-analysis/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/lib/project-analysis/project-analyzer.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function runProjectAnalysis(projectKey = "core") {
    ...
    for (const scanPath of preset.scanPaths){
        const fullPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["join"](projectRoot, scanPath);
        if (!__TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["existsSync"](fullPath)) continue;
        const stats = __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["statSync"](fullPath);
        if (stats.isFile()) {
            const ext = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["extname"](fullPath).toLowerCase();
            if ([
                ".ts",
                ".tsx"
            ].includes(ext)) tsFiles.push(fullPath);
    ...
    for (const filePath of tsFiles){
        try {
            ...
            const relativePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["relative"](projectRoot, filePath).replace(/\\/g, "/");
            if (result.consoleLogCount > 0) consoleLogFiles.push({
                path: relativePath,
                hint: `${result.consoleLogCount}x`
            });
            if (result.anyTypeCount > 0) anyTypeFiles.push({
                path: relativePath,
                hint: `${result.anyTypeCount}x`
            });
            if (result.todoCount > 0) todoFiles.push({
                path: relativePath,
                hint: `${result.todoCount}x`
            });
            if (result.sqlTemplateCount > 0) sqlTemplateFiles.push({
                path: relativePath,
                hint: `${result.sqlTemplateCount}x`
            });
            if (result.dropTableCount > 0) dropTableFiles.push({
                path: relativePath,
                hint: `${result.dropTableCount}x`
            });
        } catch (e) {}
    }
    const scores = calculateScores({
        consoleLogCount: totalConsoleLog,
        anyTypeCount: totalAnyType,
        todoCount: totalTodo,
        sqlTemplateCount: totalSqlTemplate,
        dropTableCount: totalDropTable,
        ariaCount: totalAria,
    ...
    return {
        ...
        metrics: {
            ...
            anyTypeCount: totalAnyType,
            todoCount: totalTodo,
            sqlTemplateQueries: totalSqlTemplate,
            dropTableCount: totalDropTable,
            filesScanned: tsFiles.length,
            totalLines,
            mdFilesCount: mdFiles.length,
...
function collectFiles(dir, extensions, result) {
    try {
        const entries = __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["readdirSync"](dir, {
            withFileTypes: true
        });
        for (const entry of entries){
            const fullPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["join"](dir, entry.name);
            if ([
                "node_modules",
                ".next",
                ".git"
            ...
            else if (entry.isFile() && extensions.includes(__TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["extname"](entry.name).toLowerCase())) {
...
function analyzeFile(filePath, projectRoot) {
    const content = __TURBOPACK__imported__module__$5b$externals$5d2f$fs__$5b$external$5d$__$28$fs$2c$__cjs$29$__["readFileSync"](filePath, "utf-8");
    return {
        path: __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["relative"](projectRoot, filePath).replace(/\\/g, "/"),
        ...
        sqlTemplateCount: (content.match(/`[^`]*\$\{[^}]*\}[^`]*(SELECT|INSERT|UPDATE|DELETE)/gi) || []).length + (content.match(/`[^`]*(SELECT|INSERT|UPDATE|DELETE)[^`]*\$\{/gi) || []).length,
...
function generateRisks(m) {
    ...
    if (m.consoleLogCount > 50) {
        risks.push({
            ...
            severity: m.consoleLogCount > 200 ? "high" : "medium",
    ...
    if (m.anyTypeCount > 50) {
        risks.push({
            id: `CQ-${String(id++).padStart(2, "0")}`,
            severity: m.anyTypeCount > 200 ? "high" : "medium",
            category: "code-quality",
    ...
    if (m.mdFilesCount > 300) {
        risks.push({
            ...
            affectedFiles: [],
            recommendation: "Konsolidiere verwandte Dokumentationen."
        });
    }
    const order = {
        critical: 0,
...
async function saveAnalysisToDatabase(summary) {
    try {
        ...
        const summaryText = `[${summary.projectKey}] ${summary.projectName} | Score: ${summary.enterpriseScore}/10 | ` + `${criticalCount}krit, ${highCount}hoch, ${mediumCount}mittel, ${lowCount}niedrig`;
        const [result] = await pool.execute(`INSERT INTO lopez_ai_project_insights 
       ...
       VALUES (0, 'summary', ?, ?, 'local', 'project-analyzer', 0, 0, NOW())`, [
            JSON.stringify({
                ...
                enterpriseScore: summary.enterpriseScore,
                criticalCount,
                highCount,
                mediumCount,
                lowCount,
...
async function getAnalysisHistory(limit = 10) {
    try {
        const pool = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getConnection"])();
        const [rows] = await pool.execute(`SELECT id, content, created_at FROM lopez_ai_project_insights 
       WHERE project_id = 0 AND insight_type = 'summary' ORDER BY created_at DESC LIMIT ?`, [
            limit
        ]);
        return rows.map((row)=>{
            try {
                ...
                return {
                    ...
                    projectKey: c.projectKey || "core",
                    projectName: c.projectName || "Unbekannt",
                    enterpriseScore: c.enterpriseScore || 0,
...
async function getAnalysisById(id) {
    try {
        const pool = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getConnection"])();
        const [rows] = await pool.execute(`SELECT content FROM lopez_ai_project_insights WHERE id = ?`, [
            id
        ]);
...
"[project]/src/app/api/admin/project-analysis/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$project$2d$analysis$2f$project$2d$analyzer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/project-analysis/project-analyzer.ts [app-route] (ecmascript)");
;
;
    ...
    try {
        ...
        if (view === "presets") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: true,
                data: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$project$2d$analysis$2f$project$2d$analyzer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PROJECT_PRESETS"]
            });
        }
        ...
        if (id) {
            ...
            const analysis = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$project$2d$analysis$2f$project$2d$analyzer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAnalysisById"])(analysisId);
            if (!analysis) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    success: false,
        ...
        // Sonst: Lade Historie
        const history = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$project$2d$analysis$2f$project$2d$analyzer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAnalysisHistory"])(limit);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            data: history,
...
async function POST(request) {
    try {
        ...
        const projectKey = body.projectKey || "core";
        const validKeys = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$project$2d$analysis$2f$project$2d$analyzer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PROJECT_PRESETS"].map((p)=>p.key);
        ...
        const preset = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$project$2d$analysis$2f$project$2d$analyzer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PROJECT_PRESETS"].find((p)=>p.key === projectKey);
        console.log(`📊 [Project-Analyzer] Starte Analyse: "${preset?.name}" (${projectKey})`);
        // Führe die READ-ONLY Analyse durch
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$project$2d$analysis$2f$project$2d$analyzer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["runProjectAnalysis"])(projectKey);
        ...
        let savedId = 0;
        try {
            savedId = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$project$2d$analysis$2f$project$2d$analyzer$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["saveAnalysisToDatabase"])(result);
            if (savedId > 0) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ac6ed74a._.js.map