module.exports = [
"[project]/.next-internal/server/app/api/admin/dev-tasks/run-build/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/admin/dev-tasks/run-build/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        // Steps laden
        const steps = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dev$2d$tasks$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DevTasksService"].getStepsForTask(taskIdNum);
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ...
            data: {
                ...
                build_status: {
                    ...
                    message: canRunBuild ? "Task ist bereit für Agent-B Build" : buildComplete ? `Build abgeschlossen: ${codeChanges.length} Code-Änderungen` : `Task-Status ist '${task.status}', Build erfordert 'planned'`
                }
            }
        });
    } catch (error) {
...
async function POST(request) {
    try {
        ...
        const buildResult = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dev$2d$orchestrator$2f$agent$2d$b$2d$builder$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AgentBBuilder"].runBuild(taskIdNum);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__878ab2cd._.js.map