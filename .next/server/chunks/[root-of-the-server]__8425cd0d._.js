module.exports = [
"[project]/.next-internal/server/app/api/admin/ai/playbooks/[code]/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/src/app/api/admin/ai/playbooks/[code]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const playbook = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$playbook$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PlaybookService"].getPlaybookByCode(code);
        if (!playbook) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: `Playbook ${code} nicht gefunden`
            }, {
                status: 404
            });
        }
        // Letzte Executions laden
        const executions = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$ai$2d$center$2f$playbook$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PlaybookService"].listExecutions(playbook.id, 10);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            data: {
                playbook,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8425cd0d._.js.map