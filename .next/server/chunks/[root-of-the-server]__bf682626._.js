...
async function executeQueryPoolWithResult(sql, params = []) {
    const pool = getConnectionPool();
...
class CustomerService {
    ...
    static async createCustomer(customerData) {
        try {
            ...
            const existingByEmail = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQueryPool"])("SELECT id, kundennummer FROM lopez_customers WHERE email = ?", [
                customerData.email
            ]);
            ...
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQueryPoolWithResult"])(`
    ...
    static async getCustomerById(id) {
        try {
            const rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQueryPool"])("SELECT * FROM lopez_customers WHERE id = ?", [
                id
            ]);
    ...
    static async getCustomerByKundennummer(kundennummer) {
        try {
            const rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQueryPool"])("SELECT * FROM lopez_customers WHERE kundennummer = ?", [
                kundennummer
            ]);
            return rows.length > 0 ? rows[0] : null;
        } catch (error) {
    ...
    static async updateCustomer(id, customerData) {
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQueryPool"])(`
    ...
    static async deleteCustomer(id) {
        try {
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQueryPool"])("DELETE FROM lopez_customers WHERE id = ?", [
                id
            ]);
            // Audit-Log
    ...
    static async searchCustomers(filters = {}) {
        try {
            ...
            const countRows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQueryPool"])(countQuery, queryParams);
            ...
            const customersQuery = `
                ...
                LIMIT ? OFFSET ?
            `;
            const customerRows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQueryPool"])(customersQuery, [
                ...queryParams,
                limit,
                offset
            ]);
    ...
    static async fuzzySearch(query, limit = 10) {
        try {
            ...
            const rows = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["executeQueryPool"])(searchQuery, [
                searchTerm,
                searchTerm,
                searchTerm,
                searchTerm,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bf682626._.js.map